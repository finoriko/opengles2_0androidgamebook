...
public class Triangle {
    ...
    public Triangle( MainGLRenderer mainGLRenderer) {
        ...
        // 모양을 나타낼 쉐이더 코드를 로당함
        int vertexShader = mGLRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);

        // 색상을 나타낼 프래그먼트 쉐이더 코드를 로딩함
        int fragmentShader = mGLRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
