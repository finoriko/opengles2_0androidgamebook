...
public class MainGLRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        // 리소스 로딩.
        mResourceLoading.loadingResource(mUnit, Map.mLand, mButtons);
    ...
    private void RenderGame(float[] m) {
        ...
        mUnit.draw(mMtrxProjectionAndView); Matrix.orthoM(mMtrxProjection, 0, 0f, ConstMgr.SCREEN_WIDTH, 0.0f,
