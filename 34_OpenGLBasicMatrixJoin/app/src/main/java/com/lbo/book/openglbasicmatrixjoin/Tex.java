package com.lbo.book.openglbasicmatrixjoin;
...
public class Tex {
    ...
    void draw(float[] m) {
        ...
        Matrix.translateM(mTranslationMatrix, 0, 200, 300,0);
        Matrix.setRotateM(mRotationMatrix, 0, 60, 0, 0, -1.0f);
        Matrix.scaleM(mScaleMatrix, 0, 2,1,1.0f);
