...
public class Square {
    ...
    public Square(MainGLRenderer mainGLRenderer) {
        ...
        int vertexShader = mMainGLRenderer.loadShader(GLES20.GL_VERTEX_SHADER, mVertexShaderCode);
        int fragmentShader = mMainGLRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, mFragmentShaderCode);
